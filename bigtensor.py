...
def average_pool_fuel(
    ...
    try:
        ...
        # Fuel files are stored as two contiguous channels:
        # [surface values for all cells, canopy values for all cells].
...
def load_flux_tensor(
    ...
    try:
        ...
        # Flux files are stored as four contiguous channels:
        # [channel1 values for all cells, channel2 values for all cells,
        #  channel3 values for all cells, channel4 values for all cells].
        flux_channels = []
