...
def build_parser() -> argparse.ArgumentParser:
	...
	parser.add_argument("--recursive", dest="recursive", action="store_true", default=True, help="Search recursively below each fire root for tensor dirs.")
	parser.add_argument("--no-recursive", dest="recursive", action="store_false", help="Limit discovery to the immediate dataset level.")
