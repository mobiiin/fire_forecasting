"""Evaluate an ST-Mamba-Lite checkpoint."""
...
def _config_override() -> dict:
	return {
		"model": {"architecture": "st_mamba_lite", "name": "st_mamba_lite"},
		"checkpoint": {
...
def build_argument_parser() -> argparse.ArgumentParser:
	parser = argparse.ArgumentParser(description="Evaluate an ST-Mamba-Lite checkpoint.")
...
def main() -> None:
	...
	aggregate_csv = Path("artifacts/logs/st_mamba_lite_test_metrics.csv").resolve()
	per_fire_csv = Path("artifacts/logs/st_mamba_lite_test_metrics_by_fire.csv").resolve()
