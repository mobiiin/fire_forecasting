"""Evaluate a CAWFE-Latte-Lite checkpoint."""
...
def _config_override() -> dict:
	return {
		"model": {"architecture": "cawfe_latte_lite", "name": "cawfe_latte_lite"},
		"checkpoint": {
...
def build_argument_parser() -> argparse.ArgumentParser:
	parser = argparse.ArgumentParser(description="Evaluate a CAWFE-Latte-Lite checkpoint.")
...
def main() -> None:
	...
	aggregate_csv = Path("artifacts/logs/cawfe_latte_lite_test_metrics.csv").resolve()
	per_fire_csv = Path("artifacts/logs/cawfe_latte_lite_test_metrics_by_fire.csv").resolve()
