"""Smoke-test CAWFE-Latte-Lite with a fake batch."""
...
def build_argument_parser() -> argparse.ArgumentParser:
	parser = argparse.ArgumentParser(description="Run a fake-batch smoke test for CAWFE-Latte-Lite.")
...
def main() -> None:
	...
	if bool(section.get("use_fire_front_gate", True)):
		...
		assert tuple(aux["fire_gate_map"].shape) == (2, sequence_length, 1, patch_size, patch_size)
